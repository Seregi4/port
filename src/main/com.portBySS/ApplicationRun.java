...
//        for (int i = 0; i < 5; i++) {
//            Ship ship = new Ship();
//            System.out.println("name " + ship.getShipID());
//            System.out.println(" cargo to load " + ship.getContainersToLoad());
//            System.out.println("cargo to unload " + ship.getContainersToUnLoad());
//            System.out.println("cargo to unload to ship " + ship.getContainersToUNLoadToShip());
//            System.out.println(" cargo in this ship " + ship.getShipContainersCount());
//        }
